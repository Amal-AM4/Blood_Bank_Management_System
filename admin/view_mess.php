...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../assets/css/view_mess.css">
...
<body>
	...
	<div class="container">
		...
		<div class="side-right">
			...
			<div class="jizz-box" data-aos="fade-down" data-aos-delay="350">
				
				<?php
					$id = $_GET['id'];
					$insert = "SELECT * FROM `tbl_request` WHERE ID = '$id'";
				...
				?>
					...
					<p class="h4">Event location : <?php echo $row['PLACE'];?></p>
					<p class="h5">Date : <?php echo $row['DATE'];?></p>
					<p class="h6">Time : <?php echo $row['TIME'];?></p>
