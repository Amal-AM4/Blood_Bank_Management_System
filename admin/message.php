...
<body>
	...
	<div class="container">
		...
		<div class="side-right">
			...
			?><br>
			<h2 data-aos="fade-down" data-aos-delay="300">Request from Users</h2>
			<?php
			...
			<div class="inboxz-box">
				<?php
					$query = "SELECT * FROM `tbl_request` ORDER BY `tbl_request`.`ID` DESC";
				...
				?>
						<div class="inbox" data-aos="fade-down" data-aos-delay="350">
							...
							<div class="right">
								<a class="eye" href="view_mess.php?id=<?php echo $row['ID'];?>">
									<i class="far fa-eye"></i>
								</a>
								<a href="del_mess.php?id=<?php echo $row['ID'];?>">
